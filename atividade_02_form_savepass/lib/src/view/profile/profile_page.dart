...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void _prefillIfNeeded(UserProfile? profile) {
    if (!_prefilled && profile != null) {
      ...
      _emailController.text = profile.recoveryEmail;
  ...
  void _saveProfile() {
    if (_formKey.currentState!.validate()) {
      ...
      context.read<SQlitePasswordController>().saveProfile(profile);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<SQlitePasswordController>(
        builder: (context, controller, _) {
          _prefillIfNeeded(controller.profile);
          return Padding(
